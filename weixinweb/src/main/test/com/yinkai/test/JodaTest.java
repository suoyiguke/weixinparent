...
import com.yinkai.utils.jedis.JedisClientPool;
import com.yinkai.springcustom.PropertiesUtils;
...
public class JodaTest {
    ...
    @Test
    public void xx(){
      ApplicationContext applicationContext =new ClassPathXmlApplicationContext("classpath:springmvc.xml","classpath:springmvc-dao.xml","classpath:springmvc-redis.xml");
        JedisClient jedisClient = (JedisClientPool)applicationContext.getBean("jedisClientPool");
        jedisClient.set("123","尹凯");
        String s = jedisClient.get("123");
    ...
    public void hh() throws Exception {
        ...
        ApplicationContext applicationContext =new ClassPathXmlApplicationContext("classpath:springmvc-dao.xml","classpath:springmvc-redis.xml");
        PropertiesUtils propertiesUtils = applicationContext.getBean(PropertiesUtils.class);
        String name = "${redis.uri.0}";
    ...
    public void gg() throws Exception {
        ...
        ApplicationContext applicationContext =new ClassPathXmlApplicationContext("classpath:springmvc-dao.xml");
        UserTopicMapper userTopicMapper = (UserTopicMapper) applicationContext.getBean("userTopicMapper");
        userTopicMapper.deleteByTopicId(107);
    }
